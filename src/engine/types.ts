...
export type GameElement		= typeof Constants.GameElements[number];
export type Status				= typeof Constants.Statuses[number];
export type EntityType		= typeof Constants.EntityTypes[number];
export type EntityCulture = typeof Constants.EntityCultures[number];
export type MoveType			= typeof Constants.MoveTypes[number];
export type MoveSpeed			= typeof Constants.MoveSpeeds[number];
export type ItemType			= typeof Constants.ItemTypes[number];
